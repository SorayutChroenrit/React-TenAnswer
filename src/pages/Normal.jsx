...
function Normal() {
  ...
  const isMounted = useRef(false); // useRef to track whether component is mounted
    ...
    if (event.key === "Enter") {
      ...
      if (isNaN(inputValue)) {
        ...
        if (usedNumbers.includes(inputValue)) {
          alert(
            "You've already guessed " + inputValue + ". Try a different number."
          );
          return;
        }
        ...
        if (inputValue === randomNumber) {
          alert(
            "Congratulations! You guessed the correct number: " + inputValue
          );
          ...
          for (var i = 1; i < 11; i++) {
            ...
            if (textElement) {
              ...
              var ellipseElement =
                circleElement.getElementsByTagName("ellipse")[0];
              ellipseElement.setAttribute("fill", "#D9D9D9");
            }
          }
  ...
  function getNextDisplayTextId() {
    ...
    setDisplayTextIndex(nextDisplayTextIndex);
